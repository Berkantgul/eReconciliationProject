...
namespace Core.Utilities.Security.JWT
{
    public class JWTHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims, int companyId)
        {
            ...
            var jwt = CreateJwtSecurityToken(_tokenOptions, user, signinCredential, operationClaims, companyId);
        ...
        public IEnumerable<Claim> SetClaims(User user, List<OperationClaim> operationClaims, int companyId)
        {
