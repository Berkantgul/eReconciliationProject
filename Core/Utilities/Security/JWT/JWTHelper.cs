...
namespace Core.Utilities.Security.JWT
{
    public class JWTHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims, int companyId, string companyName)
        {
            ...
            var signinCredential = SigningCredentialHelper.CreateSigninCredentials(securityKey);
            var jwt = CreateJwtSecurityToken(_tokenOptions, user, signinCredential, operationClaims, companyId, companyName);
        ...
        public IEnumerable<Claim> SetClaims(User user, List<OperationClaim> operationClaims, int companyId,string companyName)
        {
